...
export default function ProductDetail() {
  ...
  // khai báo kho lưu trữ set số lượng sp, quantitycontroller
  ...
  // function hover slider
  const chooseCurrent = image => setCurrentImage(image)

  // function button prev slider
  const choosePrev = () => {
